...
packages:
  ...
  /@nestjs/cli/9.1.3:
    resolution: {integrity: sha512-ILACqDDrplvOb7HwCFJCvghMyXSHPwhqzxzant4AwYzu3BGsZVQG7TRNPxu+qfHZH6o4EBglpBwkb+8vbnVBKA==}
    engines: {node: '>= 12.9.0'}
    hasBin: true
    dependencies:
      '@angular-devkit/core': 14.2.2_chokidar@3.5.3
      ...
      cli-table3: 0.6.2
      commander: 4.1.1
      fork-ts-checker-webpack-plugin: 7.2.13_kb3egcnme7w23lfa5xodfjfhge
      inquirer: 7.3.3
      node-emoji: 1.11.0
      ora: 5.4.1
      os-name: 4.0.1
